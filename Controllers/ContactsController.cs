...
namespace WhatsYourAddy.Controllers
{
    public class ContactsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FirstName,LastName,Email,PhoneNumber,Address1,Address2,City,State,PostalCode,Date,ImageData,ImageType,Id")] Contact contact)
        {
            if (id != contact.Id)
            {
                return NotFound();
